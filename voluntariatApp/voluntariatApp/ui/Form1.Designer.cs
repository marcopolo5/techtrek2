namespace voluntariatApp
{
	partial class frmLogare
	{
		...
		private void InitializeComponent()
		{
			...
			lblWellcome.Location = new Point(105, 15);
			lblWellcome.Name = "lblWellcome";
			lblWellcome.Size = new Size(284, 52);
			...
			// txtName
			// 
			txtName.Location = new Point(237, 205);
			...
			// txtPassword
			// 
			txtPassword.Location = new Point(237, 240);
			...
			likSingUp.Size = new Size(105, 23);
			...
			// pictureBox1
			// 
			//pictureBox1.Image = voluntariatApp.Properties.Resources.image;
