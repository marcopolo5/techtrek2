namespace voluntariatApp
{
    partial class SignUpVoluntar2
    {
		...
		private void InitializeComponent()
		{
			...
			cmbOccupation.Items.AddRange(new object[] { " Student,", "        Elev", "        Angajat", "        Pensionar", "        Somer", "        Other" });
			...
			Name = "SignUpVoluntar2";
			StartPosition = FormStartPosition.CenterScreen;
			Text = "SignUpVoluntar2";
